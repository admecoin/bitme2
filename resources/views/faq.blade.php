				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 col-md-12">
							    ...
							    <div class="card">
							    	<div class="card-header collapsed" data-toggle="collapse" href="#collapse1">
						                <a class="card-title">
						                    ...
						                    What is bitcoinnearme.com?
						                </a>
						            </div>	
							      	<div id="collapse1" class="card-body collapse" data-parent="#accordion" >
					                	<p>BitcoinNearMe is an independent peer-to-peer marketplace which serves as a platform where you can trade cryptocurrencies in exchange for fiat money via escrow smart contracts. Trades can be done via several methods such as bank transfers, cash payments or cash deposits, PayPal, Alipay, etc.</p>
					            	</div>
							    </div>
							    <div class="card">
							      ...
							      <div id="collapse2" class="card-body collapse" data-parent="#accordion">
							        <p>
							          BitcoinNearMe charges a 0.70% maker price and 0.30% taker price. The maker price is charged to the one who puts on the offer listing, while the taker price is charged to the person responding to the offer.
							        </p>
							      </div>
							    </div>
							    <div class="card">
							...
							<h2 class="mt-28">Using BitcoinNearMe</h2>
							<div id="accordion" class="accordion">
							    <div class="card">
							    ...
							    <div class="card">
							      ...
							      <div id="collapse5" class="card-body collapse" data-parent="#accordion">
							        	...
							        	<p>
											Offer and trade rates, are prices which are fixed on default, are the reasons buyers and sellers see different price for the same trade. What you see as prices will be what you will receive after BitcoinNearMe fee is deducted.
										</p>
										<p>BitcoinNearMe charges 0.30% for the maker and 0.70% for the taker.</p>
										<p>The fee system works like this:</p>
										<ul>
											<li>When the maker is the seller: Buyer's rate = ([Seller's rate] * (1 + 0.003%) * (1 + 0.007%)</li>
							...
							<h2 class="mt-28">Manage your wallet</h2>
							<div id="accordion" class="accordion">
							    <div class="card">
							      <div class="card-header collapsed" data-toggle="collapse" href="#collapse7">
							      	<a class="card-title">
					                	<i class="fa" aria-hidden="true"></i>
					                    How does BitcoinNearMe keep my cryptocurrencies?
					                </a>
							      </div>

							      <div id="collapse7" class="card-body collapse" data-parent="#accordion">
							        <p>
							          Your wallet on bitcoinnearme.com has been fully encrypted on your browser. Like encrypted messages, your wallet is developed to allow your funds to be created offline in your browser. Neither do we nor any of our staffs have access to your funds.
							        </p>
							      </div>
							    </div>
							    <div class="card">
							      <div class="card-header collapsed" data-toggle="collapse" href="#collapse8">
							      	<a class="card-title">
					                	<i class="fa" aria-hidden="true"></i>
					                    How do I deposit cryptocurrencies into my BitcoinNearMe wallet?
					                </a>
							      </div>
							    ...
							    <div class="card">
							      ...
							      <div id="collapse9" class="card-body collapse" data-parent="#accordion">
							        <p>
							          Digital transactions are generally irreversible. If you send funds to a wrong address, contact the party and wait for them to return it. However, there is a slim chance of retrieving if sent to a wrong address and BitcoinNearMe will not be held liable for this.
							        </p>
							      </div>
							    </div>
							    <div class="card">
							      ...
							      <div id="collapse10" class="collapse card-body" data-parent="#accordion">
							        <p>
							...
							<h2 class="mt-28">Security</h2>
							<div id="accordion" class="accordion">
								<div class="card">
							      <div class="card-header collapsed" data-toggle="collapse" href="#collapse11">
							      	<a class="card-title">
					                	<i class="fa" aria-hidden="true"></i>
					                    Is my privacy safe?
					                </a>
							    ...
							    <div class="card">
							      <div class="card-header collapsed" data-toggle="collapse" href="#collapse12">
							      	<a class="card-title">
					                	<i class="fa" aria-hidden="true"></i>
							      ...
							      <div id="collapse12" class="card-body collapse" data-parent="#accordion">
							        <div class="">
							        	<p>Put simply, your message is encrypted into your browser. No one, our team inclusive, can read your messages. When viewed from our servers, those messages are bunches of random numbers of matrices. Once you destroy messages keys, the conservation is gone forever.</p>
										<p>However certain situations may have one of the parties release the key to our team, only on these occasions can we read your messages.</p>
							        </div>
							      </div>
							    </div>
							</div>
